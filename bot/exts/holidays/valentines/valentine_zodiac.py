...
class ValentineZodiac(commands.Cog):
    ...
    def load_comp_json() -> tuple[dict, dict]:
        ...
        explanation_file = Path(
            "bot/resources/holidays/valentines/zodiac_explanation.json"
        )
        compatibility_file = Path(
            "bot/resources/holidays/valentines/zodiac_compatibility.json"
        )
    ...
    async def date_and_month(
        self, ctx: commands.Context, date: int, month: Union[int, str]
    ) -> None:
